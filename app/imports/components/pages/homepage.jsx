...
export const Homepage = (props) => {
  ...
  //Here we are instantiating a PageTitle component and passing a value for the 'title' prop.  I recommend heading over to /content/page_title to see how this corresponds to the component itself.
    ...
    // You could have done this: displayList = () => props.subsReady? - DON'T, this is bad. You are calling a variable directly that is outside the scope of the function rather than passing it in as an argumenty.  Avoid doing so when possible.
